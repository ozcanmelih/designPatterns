...
public class MyApplication {
	 ...
	 * then use it. This leads to hard-coded dependency. If we want to switch to
	 * some other advanced email service in future, it will require code changes
	 * in MyApplication class. This makes our application hard to extend and if
	 * email service is used in multiple classes then that would be even more
	 * harder.
	 */
